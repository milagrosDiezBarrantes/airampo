(function($) {
    ...
    $('.filters ul li').on("click", function(event) {
        event.preventDefault();
    ...
    $('#btnform').on('click', function() {
        ...
        // alert('sad');
        $("#modalform1").addClass("open");
    });
    $('#btnwsp').on('click', function() {
        window.open('https://api.whatsapp.com/send?phone=', '_blank');

    });

    //   <----modal Form
    $('.modalbtnform1 a').on("click", function(event) {
        event.preventDefault();
        $("#modalform1").addClass("open");

    });

    $("#modalform1, #modalform1 button.close").on("click keyup", function(event) {
        if (
            event.target == this ||
            event.target.className == "close" ||
            event.keyCode == 27

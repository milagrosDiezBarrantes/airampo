                                        ...
                                        {{-- <div class="more-info-content"> --}}
                                            <div id="modaltitle">
                                                ...
                                                <div class="left-image" >                
                                                    <div class="Modern-Slider">
                                                            ...
                                                            <div class="img-fill">
                                                                <img id="imgcarrousel1" class="imgbckgnd" src="{{ asset("airampo/img/galleria/airampo_polo.jpeg") }}" alt="">
                                                            </div>
                                                            </div>
                                                            <!-- // Item -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="modaldescrip" class="col-md-7">
                                                    ...
                                                    <p>Rodeado de entre medio de cerros pintorescos encontramos un centro ecuestre, la cual se encuentra adaptada y acondicionada para la cría, cuidado y entrenamiento de caballos, dos canchas de polos y una pista de equitación.
                                                    <br><br>

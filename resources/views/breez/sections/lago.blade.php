                            ...
                            <div class="section-heading">
                                ...
                                <div class="filters">
                                    <ul>
                                        ...
                                        >ZONA BOULEVARD</li>
                                        <li class="active" data-titulo = "ZONA LAGO" 
                                            data-descrip = "/lago"
                                            data-link = "/lago"
                                            data-imgcarrousel1 = "{{ asset("airampo/img/render1_1200x750.jpg") }}" 
                                        ...
                                        {{-- <div class="more-info-content"> --}}
                                            ...
                                            <div class="col-md-12">
                                                <div class="left-image" >                
                                                    <div class="Modern-Slider">
                                                            ...
                                                            <div class="img-fill">
                                                                <img id="imgcarrousel1" class="imgbckgnd" src="{{ asset("airampo/img/galleria/airampo_lago.jpeg") }}" alt="">
                                                            </div>
                                                            </div>
                                                            <!-- // Item -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div id="modaldescrip" class="col-md-7">
                                                    ...
                                                    <p>En esta zona nos encontramos con una gran bahía de playas verdes y una península, que forman una entrada única y natural hacia el agua. La misma cuenta con un centro náutico para el servicio de primer nivel para todo tipo de embarcaciones. 
                                                    <br><br>

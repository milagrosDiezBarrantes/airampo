...
<body>
    ...
    <div class="page-heading" style=" background-image: url('https://airampo.com.ar/fotos/home2.jpg');">
        <div class="container">
    ...
    <div class="more-about-us" style="background-image: url('{{ asset('airampo/img/airampo_1.jpeg') }}')">
        <div class="container">
